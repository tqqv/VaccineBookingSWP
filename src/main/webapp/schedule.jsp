<%-- 
    Document   : schedule
    Created on : Jun 6, 2023, 3:32:46 PM
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="my-5">
                        <h3 style="margin-top: 100px;">Schedule an appointment for injections</h3>
                        <hr>
                    </div>

                    <form class="file-upload" style="display: flex; justify-content: center;">
                            ...
                            <div class="col-xxl-8 mb-5 mb-xxl-0">
                                <div class="bg-secondary-soft px-4 py-5 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Name Patient</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="popup">
                                                <input type="text" id="selectedVaccineInput" onclick="showPopup()" readonly>
                                                <div id="vaccinePopup" class="popup-content">
                                                    <input type="text" id="searchVaccineInput" oninput="filterVaccineList()" placeholder="Search Vaccine">
                                                    <ul id="vaccineList" style="list-style: none;">
                                                        <c:forEach items="${listVc}" var="listVc">
                                                            <li class="vaccine-list-item" onclick="selectVaccine('${listVc.name}')">${listVc.name}</li>
                                                            </c:forEach>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="hospital" class="form-label">Choose Hospital</label><br>
                                            <select name="hospital" class="form-select form-select-md mb-3">
